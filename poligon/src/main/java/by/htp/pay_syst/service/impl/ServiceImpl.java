...
public class ServiceImpl implements Service {
	...
	public String payment(PaymentParameters paym) throws ServiceException {
		...
		// String idAccountRecipient =
		// String.valueOf(paym.getIdAccountRecipient());
	...
	@Override
	public String transferBetweenUsersCards(int idCardFrom, int idCardTo, int amount, int idUser)
			throws ServiceException {
		String resp;
	...
	@Override
	public String correctionIdentificNumberPassport(String newIdentificNumbPassport, int idUser)
			throws ServiceException {
		String resp;
