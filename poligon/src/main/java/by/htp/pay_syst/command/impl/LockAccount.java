...
public class LockAccount implements Command {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try {
			...
			response.sendRedirect("http://localhost:8080/Poligon/controller?command=GO_TO_LOCK_ACCOUNT");
...
//		
//		
//		RequestDispatcher dispatcher= request.getRequestDispatcher(JSPPageName.ADMIN_LOCK_ACCOUNT_PAGE);
