...
public class AddCard implements Command {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		param.setPaySystCard(
				Integer.parseInt(request.getParameter(RequestParameterName.REQ_PARAM_ADDCARD_PAYM_SYST_CARD)));
		...
		try {
			...
			response.sendRedirect("controller?command=GO_TO_ADD_CARD_USER");
